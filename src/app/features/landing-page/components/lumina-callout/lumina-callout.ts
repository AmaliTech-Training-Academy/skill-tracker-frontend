...
export class LuminaCallout {
  ...
  public description = 'Our built-in AI guide and tutor, Lumina, creates personalized challenges designed just for you, shedding light on complex concepts and helping you find your way when you get stuck.';
  public buttonText = 'Meet Lumina';
